...
def writeDeclarations(): #soon --> pass the predicates in the domain.pddl file to this function
    with open(outFile, 'a+') as o:
        o.write("int at_curb[numOfcars + 1];\n")
        o.write("int at_curb_num[numOfcars + 1][numOfcurbs + 1];\n")
        o.write("int behind_car[numOfcars + 1][numOfcars + 1];\n")
        o.write("int car_clear[numOfcars + 1];\n")
        o.write("int curb_clear[numOfcurbs + 1];\n")
        o.write("\n")
